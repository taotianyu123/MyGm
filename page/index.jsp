            ...
            <ul id="left2" class="layui-nav layui-nav-tree"  lay-filter="test">
                <li class="layui-nav-item layui-nav-itemed">
                    ...
                    <dl class="layui-nav-child">
                        ...
                        <dd><a target="iframe_context"  href="addCustomer.html">查询顾客</a></dd>
                    </dl>
                </li>
                <li class="layui-nav-item">
                    <a class="layui-icon" href="javascript:;" style="color:#9FC105">&#xe621;&nbsp;&nbsp;分类管理</a>
                    <dl class="layui-nav-child">
                        <dd><a target="iframe_context" href="doStu?action=queryScore&pageNumber=1&orderBy=desc">大分类管理</a></dd>
